; ======================================================================================================================
;  Class InCellEdit - ListView in-cell editing for AHK v2 - minimal version
; ======================================================================================================================
Class InCellEdit {
   ; -------------------------------------------------------------------------------------------------------------------
   __New(LV) {
      ...
      LV.OnNotify(-2, This.DoubleClickFunc)  ; One click edit
      ;LV.OnNotify(-3, This.DoubleClickFunc) ; Two click edit
      This.LV := LV
      This.HWND := LV.Hwnd
      This.Changes := []
   }
   ...
   EndLabelEdit(LV, L) {
      ...
      If (TxtPtr := NumGet(L, OffText, "UPtr")) {
         ...
         If (ItemText != This.ItemText) {
            ...
            This.Changes.Push({Row: This.Item + 1, Col: This.Subitem + 1, Value: LV.GetText(This.Item + 1, This.Subitem + 1)})
         }
      }
      Return False
   }
